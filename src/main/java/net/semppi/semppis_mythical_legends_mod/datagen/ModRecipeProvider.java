...
public class ModRecipeProvider extends RecipeProvider implements IConditionBuilder {
    ...
    protected void buildRecipes(RecipeOutput recipeOutput) {
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.CARE_BRUSH.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "care_brush"));
        ...
        ShapedRecipeBuilder.shaped(RecipeCategory.MISC, ModItems.STAMP.get(), 6)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "stamp"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COD_SOUP.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cod_soup"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.BAKED_CHEESY_FISH.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "baked_cheesy_fish"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.PORRIDGE.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "porridge"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HONEYED_PORRIDGE.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "honeyed_porridge"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.CHOCOLATE_PORRIDGE.get())
                ...
                .requires(Items.SUGAR)
                .unlockedBy("has_porridge", has(ModItems.PORRIDGE.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chocolate_porridge"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RICOTTA_CHEESE.get(), 6)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "ricotta_cheese"));

        // Shapeless recipe for Butter
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.BUTTER.get(), 2)
                .requires(Items.MILK_BUCKET)
                .unlockedBy("has_milk", has(Items.MILK_BUCKET))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "butter"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.OIL.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "oil"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.SWEET_BERRY_JAM.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "sweet_berry_jam"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.CHOCOLATE_BUTTER.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chocolate_butter"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.NOPALE_PASTE.get(), 8)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "nopale_paste"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.SWEET_BERRY_JAM_ON_BREAD.get(), 2)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "sweet_berry_jam_on_bread"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.CHOCOLATE_BUTTER_ON_BREAD.get(), 2)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chocolate_butter_on_bread"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.NOPALE_PASTE_ON_BREAD.get(), 2)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "nopale_paste_on_bread"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.SPANAKOPITA.get(), 2)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "spanakopita"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HONEYED_MEAT_PIE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "honeyed_meat_pie"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HONEYED_BERRY_TREAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "honeyed_berry_treat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.FISHY_KELP_TREAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "fishy_kelp_treat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_FISHY_KELP_TREAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_fishy_kelp_treat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.VEGGIE_KELP_TREAT.get())
                ...
                .requires(Items.KELP)
                .unlockedBy("has_kelp", has(Items.KELP))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "veggie_kelp_treat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_VEGGIE_KELP_TREAT.get())
                ...
                .requires(Items.DRIED_KELP)
                .unlockedBy("has_dried_kelp", has(Items.DRIED_KELP))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_veggie_kelp_treat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BEEF_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_beef_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_STEAK_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_steak_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.BEEF)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_beef"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.COOKED_BEEF)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_steak"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BEEF_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.BEEF), has(Items.BEEF))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_beef_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_STEAK_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.COOKED_BEEF), has(Items.COOKED_BEEF))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_steak_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.BEEF, 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_beef"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.COOKED_BEEF, 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_steak"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_PORKCHOP_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_porkchop_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_PORKCHOP_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_porkchop_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.PORKCHOP)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_porkchop"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.COOKED_PORKCHOP)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_porkchop"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_PORKCHOP_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.PORKCHOP), has(Items.PORKCHOP))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_porkchop_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_PORKCHOP_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.COOKED_PORKCHOP), has(Items.COOKED_PORKCHOP))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_porkchop_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.PORKCHOP, 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_porkchop"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.COOKED_PORKCHOP, 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_porkchop"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_MUTTON_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_mutton_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_MUTTON_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_mutton_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.MUTTON)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_mutton"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.COOKED_MUTTON)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_mutton"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_MUTTON_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.MUTTON), has(Items.MUTTON))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_mutton_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_MUTTON_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.COOKED_MUTTON), has(Items.COOKED_MUTTON))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_mutton_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.MUTTON, 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_mutton"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.COOKED_MUTTON, 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_mutton"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AVIAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_chicken_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AVIAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_chicken_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AVIAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_avian_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AVIAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_avian_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AVIAN_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_avian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AVIAN_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_avian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AVIAN_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.CHICKEN), has(Items.CHICKEN))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_chicken_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AVIAN_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.COOKED_CHICKEN), has(Items.COOKED_CHICKEN))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_chicken_to_chunk"));

        // Shapeless recipe crafting 4 Raw Avian Meat to a Chunk
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AVIAN_CHUNK.get())
                .requires(ModItems.RAW_AVIAN_MEAT.get(), 4)
                .unlockedBy(getHasName(ModItems.RAW_AVIAN_MEAT.get()), has(ModItems.RAW_AVIAN_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_avian_meat_to_chunk"));

        // Shapeless recipe crafting 4 Cooked Avian Meat to a Chunk
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AVIAN_CHUNK.get())
                .requires(ModItems.COOKED_AVIAN_MEAT.get(), 4)
                .unlockedBy(getHasName(ModItems.COOKED_AVIAN_MEAT.get()), has(ModItems.COOKED_AVIAN_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_avian_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AVIAN_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_avian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AVIAN_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_avian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BUSHMEAT_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_rabbit_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BUSHMEAT_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_rabbit_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BUSHMEAT_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_bushmeat_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BUSHMEAT_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_bushmeat_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BUSHMEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_bushmeat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BUSHMEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_bushmeat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BUSHMEAT_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.RABBIT), has(Items.RABBIT))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_rabbit_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BUSHMEAT_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.COOKED_RABBIT), has(Items.COOKED_RABBIT))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_rabbit_to_chunk"));

        // Shapeless recipe crafting 4 Raw Bushmeat to a Chunk
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BUSHMEAT_CHUNK.get())
                .requires(ModItems.RAW_BUSHMEAT.get(), 4)
                .unlockedBy(getHasName(ModItems.RAW_BUSHMEAT.get()), has(ModItems.RAW_BUSHMEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_bushmeat_to_chunk"));

        // Shapeless recipe crafting 4 Cooked Bushmeat to a Chunk
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BUSHMEAT_CHUNK.get())
                .requires(ModItems.COOKED_BUSHMEAT.get(), 4)
                .unlockedBy(getHasName(ModItems.COOKED_BUSHMEAT.get()), has(ModItems.COOKED_BUSHMEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_bushmeat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BUSHMEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_bushmeat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BUSHMEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_bushmeat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_FISH_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_fish_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_FISH_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_fish_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_FISH_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_fish_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_FISH_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_fish_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_FISH_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.COD), has(Items.COD))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_fish_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_FISH_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.COOKED_COD), has(Items.COOKED_COD))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_fish_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_FISH_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_fish_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_FISH_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_fish_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_UNGULATE_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_ungulate_meat_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_UNGULATE_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_ungulate_meat_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_UNGULATE_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_ungulate_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_UNGULATE_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_ungulate_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_UNGULATE_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.RAW_UNGULATE_MEAT.get()), has(ModItems.RAW_UNGULATE_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_ungulate_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_UNGULATE_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.COOKED_UNGULATE_MEAT.get()), has(ModItems.COOKED_UNGULATE_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_ungulate_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_UNGULATE_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_ungulate_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_UNGULATE_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_ungulate_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_CRUSTACEAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_crustacean_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_CRUSTACEAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_crustacean_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_CRUSTACEAN_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_crustacean_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_CRUSTACEAN_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_crustacean_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_CRUSTACEAN_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.RAW_CRUSTACEAN_MEAT.get()), has(ModItems.RAW_CRUSTACEAN_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_crustacean_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_CRUSTACEAN_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.COOKED_CRUSTACEAN_MEAT.get()), has(ModItems.COOKED_CRUSTACEAN_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_crustacean_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_CRUSTACEAN_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_crustacean_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_CRUSTACEAN_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_crustacean_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_MOLLUSC_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_mollusc_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_MOLLUSC_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_mollusc_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_MOLLUSC_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_mollusc_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_MOLLUSC_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_mollusc_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_MOLLUSC_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.RAW_MOLLUSC_MEAT.get()), has(ModItems.RAW_MOLLUSC_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_mollusc_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_MOLLUSC_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.COOKED_MOLLUSC_MEAT.get()), has(ModItems.COOKED_MOLLUSC_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_mollusc_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_MOLLUSC_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_mollusc_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_MOLLUSC_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_mollusc_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AMPHIBIAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_amphibian_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AMPHIBIAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_amphibian_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AMPHIBIAN_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_amphibian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AMPHIBIAN_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_amphibian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AMPHIBIAN_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.RAW_AMPHIBIAN_MEAT.get()), has(ModItems.RAW_AMPHIBIAN_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_amphibian_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AMPHIBIAN_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.COOKED_AMPHIBIAN_MEAT.get()), has(ModItems.COOKED_AMPHIBIAN_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_amphibian_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AMPHIBIAN_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_amphibian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AMPHIBIAN_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_amphibian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_REPTILIAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_reptilian_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_REPTILIAN_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_reptilian_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_REPTILIAN_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_reptilian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_REPTILIAN_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_reptilian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_REPTILIAN_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.RAW_REPTILIAN_MEAT.get()), has(ModItems.RAW_REPTILIAN_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_reptilian_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_REPTILIAN_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.COOKED_REPTILIAN_MEAT.get()), has(ModItems.COOKED_REPTILIAN_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_reptilian_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_REPTILIAN_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_reptilian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_REPTILIAN_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_reptilian_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AQUATIC_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_aquatic_meat_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AQUATIC_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_aquatic_meat_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AQUATIC_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_aquatic_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AQUATIC_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_aquatic_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AQUATIC_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.RAW_AQUATIC_MEAT.get()), has(ModItems.RAW_AQUATIC_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_aquatic_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AQUATIC_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.COOKED_AQUATIC_MEAT.get()), has(ModItems.COOKED_AQUATIC_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_aquatic_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_AQUATIC_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_aquatic_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_AQUATIC_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_aquatic_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HUMANOID_FLESH_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "humanoid_flesh_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HUMANOID_STEAK_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "humanoid_steak_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HUMANOID_FLESH.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_humanoid_flesh"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HUMANOID_STEAK.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_humanoid_steak"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HUMANOID_FLESH_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.HUMANOID_FLESH.get()), has(ModItems.HUMANOID_FLESH.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "humanoid_flesh_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HUMANOID_STEAK_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.HUMANOID_STEAK.get()), has(ModItems.HUMANOID_STEAK.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "humanoid_steak_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HUMANOID_FLESH.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_humanoid_flesh"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.HUMANOID_STEAK.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_humanoid_steak"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.ROTTEN_FLESH_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "rotten_flesh_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.ROTTEN_FLESH)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_rotten_flesh"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.ROTTEN_FLESH_CHUNK.get())
                ...
                .unlockedBy(getHasName(Items.ROTTEN_FLESH), has(Items.ROTTEN_FLESH))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "rotten_flesh_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, Items.ROTTEN_FLESH, 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_rotten_flesh"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_SCUTTLE_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_scuttle_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_SCUTTLE_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_scuttle_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_SCUTTLE_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_scuttle_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_SCUTTLE_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_scuttle_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_SCUTTLE_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.RAW_SCUTTLE_MEAT.get()), has(ModItems.RAW_SCUTTLE_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_scuttle_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_SCUTTLE_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.COOKED_SCUTTLE_MEAT.get()), has(ModItems.COOKED_SCUTTLE_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_scuttle_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_SCUTTLE_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_scuttle_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_SCUTTLE_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_scuttle_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BEAST_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_beast_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BEAST_PIECE.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_beast_to_piece"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BEAST_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_raw_beast_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BEAST_MEAT.get())
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "piece_to_cooked_beast_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BEAST_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.RAW_BEAST_MEAT.get()), has(ModItems.RAW_BEAST_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "raw_beast_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BEAST_CHUNK.get())
                ...
                .unlockedBy(getHasName(ModItems.COOKED_BEAST_MEAT.get()), has(ModItems.COOKED_BEAST_MEAT.get()))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "cooked_beast_meat_to_chunk"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.RAW_BEAST_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_raw_beast_meat"));
        ...
        ShapelessRecipeBuilder.shapeless(RecipeCategory.FOOD, ModItems.COOKED_BEAST_MEAT.get(), 4)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, "chunk_to_cooked_beast_meat"));
    ...
    private void createCookingRecipe(RecipeOutput recipeOutput, ItemLike input, ItemLike output, float experience, int cookingTime, String group) {
        ...
        SimpleCookingRecipeBuilder.smelting(Ingredient.of(input), RecipeCategory.FOOD, output, experience, cookingTime)
                ...
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, getItemName(input) + "_smelting"));
...
//                .save(recipeOutput, new ResourceLocation(SemppisMythicalLegendsMod.MOD_ID, getItemName(input) + "_blasting"));
        ...
        SimpleCookingRecipeBuilder.smoking(Ingredient.of(input), RecipeCategory.FOOD, output, experience, cookingTime / 2)
                .group(group)
                .unlockedBy(getHasName(input), has(input))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, getItemName(input) + "_smoking"));

        // Campfire Cooking
        SimpleCookingRecipeBuilder.campfireCooking(Ingredient.of(input), RecipeCategory.FOOD, output, experience, cookingTime * 3)
                .group(group)
                .unlockedBy(getHasName(input), has(input))
                .save(recipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, getItemName(input) + "_campfire_cooking"));
    }
    ...
    private static <T extends AbstractCookingRecipe> void oreCooking(RecipeOutput pRecipeOutput, RecipeSerializer<T> pSerializer, AbstractCookingRecipe.Factory<T> pRecipeFactory, List<ItemLike> pIngredients, RecipeCategory pCategory, ItemLike pResult, float pExperience, int pCookingTime, String pGroup, String pSuffix) {
        for (ItemLike itemlike : pIngredients) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), pCategory, pResult, pExperience, pCookingTime, pSerializer, pRecipeFactory)
                    ...
                    .save(pRecipeOutput, ResourceLocation.fromNamespaceAndPath(SemppisMythicalLegendsMod.MOD_ID, getItemName(itemlike) + pSuffix));
        }
    }
}