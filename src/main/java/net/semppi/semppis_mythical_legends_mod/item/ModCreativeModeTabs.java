    ...
    public static final RegistryObject<CreativeModeTab> SML_FOOD = CREATIVE_MODE_TABS.register("smlfoodtab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.COD_SOUP.get()))
                    ...
                    .displayItems((pParameters, pOutput) -> {
                        ...
                        pOutput.accept(ModItems.GLOW_BERRY_JAM_ON_BREAD.get());
                        ...
                        pOutput.accept(ModItems.RAW_FEY_PIECE.get());
                        pOutput.accept(ModItems.COOKED_FEY_PIECE.get());
                        pOutput.accept(ModItems.RAW_FEY_MEAT.get());
                        pOutput.accept(ModItems.COOKED_FEY_MEAT.get());
                        pOutput.accept(ModItems.RAW_FEY_CHUNK.get());
                        pOutput.accept(ModItems.COOKED_FEY_CHUNK.get());
                        pOutput.accept(ModItems.DRACONIC_FLESH_PIECE.get());
                        pOutput.accept(ModItems.DRACONIC_STEAK_PIECE.get());
                        pOutput.accept(ModItems.DRACONIC_FLESH.get());
                        pOutput.accept(ModItems.DRACONIC_STEAK.get());
                        pOutput.accept(ModItems.DRACONIC_FLESH_CHUNK.get());
                        pOutput.accept(ModItems.DRACONIC_STEAK_CHUNK.get());
                        pOutput.accept(ModItems.ABERRANT_FLESH_PIECE.get());
                        pOutput.accept(ModItems.COOKED_ABERRANT_PIECE.get());
                        pOutput.accept(ModItems.ABERRANT_FLESH.get());
                        pOutput.accept(ModItems.COOKED_ABERRANT_MEAT.get());
                        pOutput.accept(ModItems.ABERRANT_FLESH_CHUNK.get());
                        pOutput.accept(ModItems.COOKED_ABERRANT_CHUNK.get());
                        pOutput.accept(ModItems.FIEND_FLESH_PIECE.get());
                        pOutput.accept(ModItems.COOKED_FIEND_PIECE.get());
                        pOutput.accept(ModItems.FIEND_FLESH.get());
                        pOutput.accept(ModItems.COOKED_FIEND_MEAT.get());
                        pOutput.accept(ModItems.FIEND_FLESH_CHUNK.get());
                        pOutput.accept(ModItems.COOKED_FIEND_CHUNK.get());
                    })
                    .build());
