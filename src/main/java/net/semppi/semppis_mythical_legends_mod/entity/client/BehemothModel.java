...
public class BehemothModel extends GeoModel<BehemothEntity> {
    @Override
    public ResourceLocation getModelResource(BehemothEntity animatable) {
        return new ResourceLocation(SemppisMythicalLegendsMod.MOD_ID, "geo/behemoth.geo.json");
    }

    @Override
    public ResourceLocation getTextureResource(BehemothEntity animatable) {
    ...
    @Override
    public void setCustomAnimations(BehemothEntity animatable, long instanceId, AnimationState<BehemothEntity> animationState) {
